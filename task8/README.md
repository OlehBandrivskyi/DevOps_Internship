...
Для работы shell-Раннера с докером необходимо добавить его в группу докера (последний должен быть установлен):
...
И выполнить команду **gcloud init** внутри пользователя gitlab-runner 
